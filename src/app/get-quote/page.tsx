...
function FeatureSmallCard({ icon, title, desc }: { icon: any, title: string, desc: string }) {
  return (
    <motion.div layout className="group flex gap-6 p-6 bg-white rounded-2xl border border-primary/5 shadow-sm hover:shadow-xl hover:-translate-y-1 transition-all duration-300">
