...
export default function AboutPage() {
  return (
    <div className="bg-white overflow-hidden selection:bg-primary/20 selection:text-primary">
      ...
      <section className="relative pt-32 pb-16 lg:pt-32 lg:pb-16">
        <div className="container mx-auto px-4">
          <div className="max-w-5xl text-left space-y-8">
            ...
            <ScrollReveal direction="up" delay={0.1}>
              <h1 className="text-[28px] md:text-[40px] lg:text-[52px] font-bold text-[#1D2348] leading-[1.1] tracking-tighter max-w-4xl">
                Empowering India With <br /><span className="text-[#2563EB]">Smart Solar Solutions</span>
              </h1>
            </ScrollReveal>
            <ScrollReveal direction="up" delay={0.2}>
              <p className="text-[14px] lg:text-[16px] text-[#475569] max-w-2xl font-medium leading-relaxed">
            ...
            <ScrollReveal direction="up" delay={0.3}>
              <div className="flex flex-wrap gap-4 pt-4">
                <Button asChild variant="default" size="lg" className="rounded-full px-10 h-10 md:h-12 text-[14px] font-bold transition-all">
                  <Link href="/get-quote">Get Free Quote</Link>
                </Button>
                <Button asChild variant="outline" size="lg" className="rounded-full px-10 h-10 md:h-12 text-[14px] font-bold transition-all">
        ...
        <div className="container mx-auto px-4">
          <div className="grid lg:grid-cols-2 gap-10 md:gap-16 items-center">
            <ScrollReveal direction="right" className="space-y-6 md:space-y-8">
              <span className="inline-block bg-[#048037] text-white px-4 py-1.5 rounded-full text-[11px] font-bold tracking-wider uppercase border border-white/10 shadow-sm">About Us</span>
              <h2 className="text-[24px] md:text-[32px] lg:text-[40px] font-bold text-[#1D2348] leading-tight tracking-tighter">
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-8 md:gap-12">
            <ScrollReveal direction="up" className="p-10 md:p-12 bg-white rounded-[40px] shadow-[0_20px_60px_rgba(145,200,255,0.18)] border border-[#E6EEF8] space-y-6">
              ...
              <h3 className="text-[18px] md:text-[24px] font-bold text-[#1D2348]">Our Mission</h3>
              <p className="text-[14px] md:text-[16px] text-[#4B587C] leading-relaxed">
            ...
            <ScrollReveal direction="up" delay={0.2} className="p-10 md:p-12 bg-white rounded-[40px] shadow-[0_20px_60px_rgba(145,200,255,0.18)] border border-[#E6EEF8] space-y-6">
              ...
              <h3 className="text-[18px] md:text-[24px] font-bold text-[#1D2348]">Our Vision</h3>
              <p className="text-[14px] md:text-[16px] text-[#4B587C] leading-relaxed">
