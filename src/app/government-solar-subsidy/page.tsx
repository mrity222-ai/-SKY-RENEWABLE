            ...
            {benefitCards.map((benefit, i) => (
              <ScrollReveal key={i} delay={i * 0.1} direction="up">
                <Card className="p-10 h-full rounded-[40px] border-none bg-[#F9F9F9] shadow-sm hover:shadow-xl transition-all group">
                  <div className="size-10 rounded-full bg-[#EEF7FF] text-[#2563EB] flex items-center justify-center mb-6 group-hover:bg-[rgba(255,152,0,0.12)] group-hover:text-[#FF9800] transition-colors">
