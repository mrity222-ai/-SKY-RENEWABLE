          ...
          <div className="grid lg:grid-cols-2 gap-16 items-start">
            ...
            <div className="space-y-12">
              <div className="space-y-6">
                <span className="text-accent font-black tracking-widest text-sm uppercase">Contact Us</span>
              ...
              <div className="grid gap-4 pt-4">
                ...
                <FeatureSmallCard 
                  ...
                  desc="Connect with our solar experts for planning, installation, and maintenance."
                />
                <FeatureSmallCard 
              ...
              <Card className="rounded-[32px] border-none shadow-2xl overflow-hidden glass-morphism">
                <CardContent className="p-8 md:p-12 space-y-8">
                  <div className="space-y-2">
                    <h3 className="text-2xl font-bold text-primary font-headline">Request a Quote</h3>
            ...
            <div className="lg:col-span-7">
              <Accordion type="single" collapsible className="w-full space-y-4">
                ...
                <FaqItem 
                  ...
                  answer="You can book a survey by filling out our main contact form above, calling us directly, or clicking the 'Book Site Survey' button found across our website. One of our certified engineers will visit within 48 hours."
                />
              </Accordion>
            </div>
          </div>
