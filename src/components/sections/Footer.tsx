        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-16 mb-20">
          <div className="lg:col-span-4 space-y-8">
            <Link href="/" className="flex items-center gap-3 group">
              ...
              <span className="text-2xl font-black tracking-tight text-primary uppercase">Arkā Solar</span>
            </Link>
            <p className="text-[13px] text-[#555] leading-[1.8] max-w-sm">
          ...
          <div className="lg:col-span-2 space-y-6">
            <h4 className="text-[11px] font-bold text-black uppercase tracking-[0.2em]">Company</h4>
          ...
          <div className="lg:col-span-3 space-y-6">
            <h4 className="text-[11px] font-bold text-black uppercase tracking-[0.2em]">Solutions</h4>
            <ul className="space-y-4">
          ...
          <div className="lg:col-span-3 space-y-6">
            <h4 className="text-[11px] font-bold text-black uppercase tracking-[0.2em]">Contact Information</h4>
            <ul className="space-y-5">
              <ContactItem icon={<Phone className="size-4 text-accent" />} text="+91 98765 43210" />
              <ContactItem icon={<Mail className="size-4 text-accent" />} text="contact@arkasolar.in" />
              <ContactItem icon={<MapPin className="size-4 text-accent" />} text="Solar Plaza, Ahmedabad, Gujarat" />
            </ul>
          </div>
        </div>

        <div className="pt-8 border-t border-neutral-100 flex flex-col md:flex-row justify-between items-center gap-6 text-[11px] text-[#777] font-medium">
...
function SocialLink({ icon }: { icon: any }) {
  return (
    <Link href="#" className="p-3 bg-[#F5F5F5] rounded-xl hover:bg-black hover:text-white transition-all text-black">
      {icon}
    </Link>
  );
}
...
function ContactItem({ icon, text }: { icon: any, text: string }) {
  return (
    <li className="flex gap-4 items-start text-[13px] text-[#555] leading-tight">
